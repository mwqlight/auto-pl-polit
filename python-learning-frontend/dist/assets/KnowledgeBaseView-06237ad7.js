import{_ as K}from"./index-920881de.js";/* empty css                   *//* empty css                  *//* empty css                 */import{E as Q,u as O,l as W,I as H,R as J,A as $,i as G,S as C,n as X,T as Y,o as Z,H as ee,U as te}from"./element-ui-08f13b0c.js";import{y as se,r as _,c as F,A as u,B as t,Q as a,I as i,M as p,P as m,a4 as f,z as d,u as g,D as z,O as o,H as ae,L as le}from"./vue-vendor-8137f92e.js";import"./monaco-aa1fb2c3.js";const oe={class:"knowledge-base-view"},ie={class:"page-header"},ne={class:"page-title"},re={class:"knowledge-container"},de={class:"search-section"},ce={class:"search-bar"},ue={class:"filter-section"},pe={class:"knowledge-grid"},_e=["onClick"],ve={class:"card-header"},me={class:"card-content"},fe={class:"card-title"},ge={class:"card-desc"},ye={class:"tech-stack"},be={class:"card-footer"},we={class:"stats"},he={class:"stat"},ke={class:"stat"},Pe={class:"update-time"},Ee={class:"pagination-section"},Ve={key:0,class:"detail-content"},De={class:"detail-header"},Se={class:"detail-meta"},Ae={class:"meta-tags"},qe={class:"meta-stats"},Ie={class:"detail-body"},Te={class:"detail-section"},Ce={class:"detail-section"},Fe={class:"tech-details"},ze={class:"detail-section"},Re={class:"code-example"},Ue={class:"code-display"},xe={class:"detail-section"},Le={class:"best-practices"},je={class:"detail-section"},Ne={class:"faq-list"},Me={class:"faq-question"},Be={class:"faq-answer"},Ke=se({__name:"KnowledgeBaseView",setup(Qe){const y=_(""),b=_(""),w=_(""),h=_(""),S=_(1),A=_(12),v=_(!1),n=_(null),R=_([{id:1,title:"Django REST API开发",description:"使用Django REST Framework构建高性能的RESTful API服务",category:"web",difficulty:"intermediate",technologies:["Django","DRF","PostgreSQL","Redis"],views:1245,rating:4.8,updatedAt:"2024-01-15",scenario:"构建企业级后端API服务，支持用户管理、数据接口、权限控制等功能",technologyDetails:[{name:"Django",description:"高级Python Web框架，提供完整的MVT架构"},{name:"DRF",description:"Django REST Framework，强大的API开发工具包"},{name:"PostgreSQL",description:"企业级关系型数据库"},{name:"Redis",description:"内存数据存储，用于缓存和会话管理"}],codeExample:`# settings.py配置
REST_FRAMEWORK = {
...
if __name__ == '__main__':
    ...
    app.run(port=5001)`,bestPractices:["每个服务保持单一职责","使用API网关进行路由和认证","实现服务发现和负载均衡","添加适当的监控和日志","使用消息队列进行异步通信"],faq:[{question:"如何处理服务间的数据一致性？",answer:"可以使用Saga模式或事件溯源保证最终一致性"},{question:"如何实现服务熔断？",answer:"可以使用Hystrix或Resilience4j等熔断器库"}]}]),U=F(()=>q.value.length),q=F(()=>{let l=R.value;if(y.value){const e=y.value.toLowerCase();l=l.filter(c=>c.title.toLowerCase().includes(e)||c.description.toLowerCase().includes(e)||c.technologies.some(k=>k.toLowerCase().includes(e)))}return b.value&&(l=l.filter(e=>e.category===b.value)),w.value&&(l=l.filter(e=>e.difficulty===w.value)),h.value&&(l=l.filter(e=>e.technologies.some(c=>c.toLowerCase().includes(h.value)))),l}),I=l=>({web:"Web开发",data:"数据分析",ai:"人工智能",automation:"自动化脚本",network:"网络编程",game:"游戏开发"})[l]||l,T=l=>({beginner:"入门",intermediate:"中级",advanced:"高级"})[l]||l,x=l=>({web:"primary",data:"success",ai:"warning",automation:"info",network:"danger",game:""})[l]||"",L=l=>({beginner:"success",intermediate:"warning",advanced:"danger"})[l]||"",j=l=>{n.value=l,v.value=!0,l.views++},N=()=>{Z.success("示例代码已复制到剪贴板，请在开发环境中尝试"),v.value=!1};return(l,e)=>{const c=Q,k=O,P=W,r=ee,E=H,V=te,M=J,B=$;return d(),u("div",oe,[t("div",ie,[t("h1",ne,[a(c,null,{default:i(()=>[a(g(G))]),_:1}),e[8]||(e[8]=p(" Python 全场景应用知识库 ",-1))]),e[9]||(e[9]=t("p",{class:"page-desc"},"探索Python在不同领域的实际应用案例和最佳实践",-1))]),t("div",re,[t("div",de,[t("div",ce,[a(k,{modelValue:y.value,"onUpdate:modelValue":e[0]||(e[0]=s=>y.value=s),placeholder:"搜索应用场景、技术栈或关键词...",size:"large",clearable:""},{prefix:i(()=>[a(c,null,{default:i(()=>[a(g(C))]),_:1})]),_:1},8,["modelValue"]),a(P,{type:"primary",size:"large"},{default:i(()=>[a(c,null,{default:i(()=>[a(g(C))]),_:1}),e[10]||(e[10]=p(" 搜索 ",-1))]),_:1})]),t("div",ue,[a(E,{modelValue:b.value,"onUpdate:modelValue":e[1]||(e[1]=s=>b.value=s),placeholder:"选择应用领域",clearable:""},{default:i(()=>[a(r,{label:"Web开发",value:"web"}),a(r,{label:"数据分析",value:"data"}),a(r,{label:"人工智能",value:"ai"}),a(r,{label:"自动化脚本",value:"automation"}),a(r,{label:"网络编程",value:"network"}),a(r,{label:"游戏开发",value:"game"})]),_:1},8,["modelValue"]),a(E,{modelValue:w.value,"onUpdate:modelValue":e[2]||(e[2]=s=>w.value=s),placeholder:"选择难度级别",clearable:""},{default:i(()=>[a(r,{label:"入门",value:"beginner"}),a(r,{label:"中级",value:"intermediate"}),a(r,{label:"高级",value:"advanced"})]),_:1},8,["modelValue"]),a(E,{modelValue:h.value,"onUpdate:modelValue":e[3]||(e[3]=s=>h.value=s),placeholder:"选择技术栈",clearable:""},{default:i(()=>[a(r,{label:"Django",value:"django"}),a(r,{label:"Flask",value:"flask"}),a(r,{label:"Pandas",value:"pandas"}),a(r,{label:"NumPy",value:"numpy"}),a(r,{label:"TensorFlow",value:"tensorflow"}),a(r,{label:"PyTorch",value:"pytorch"})]),_:1},8,["modelValue"])])]),t("div",pe,[(d(!0),u(m,null,f(q.value,s=>(d(),u("div",{key:s.id,class:"knowledge-card",onClick:D=>j(s)},[t("div",ve,[t("div",{class:z(["category-tag",s.category])},o(I(s.category)),3),t("div",{class:z(["difficulty-badge",s.difficulty])},o(T(s.difficulty)),3)]),t("div",me,[t("h3",fe,o(s.title),1),t("p",ge,o(s.description),1),t("div",ye,[(d(!0),u(m,null,f(s.technologies,D=>(d(),ae(V,{key:D,size:"small",type:"info"},{default:i(()=>[p(o(D),1)]),_:2},1024))),128))])]),t("div",be,[t("div",we,[t("span",he,[a(c,null,{default:i(()=>[a(g(X))]),_:1}),p(" "+o(s.views),1)]),t("span",ke,[a(c,null,{default:i(()=>[a(g(Y))]),_:1}),p(" "+o(s.rating),1)])]),t("div",Pe," 更新: "+o(s.updatedAt),1)])],8,_e))),128))]),t("div",Ee,[a(M,{"current-page":S.value,"onUpdate:currentPage":e[4]||(e[4]=s=>S.value=s),"page-size":A.value,"onUpdate:pageSize":e[5]||(e[5]=s=>A.value=s),"page-sizes":[12,24,36,48],total:U.value,layout:"total, sizes, prev, pager, next, jumper",background:""},null,8,["current-page","page-size","total"])])]),a(B,{modelValue:v.value,"onUpdate:modelValue":e[7]||(e[7]=s=>v.value=s),title:n.value?.title,width:"90%",top:"5vh","custom-class":"knowledge-detail-dialog"},{footer:i(()=>[a(P,{onClick:e[6]||(e[6]=s=>v.value=!1)},{default:i(()=>[...e[16]||(e[16]=[p("关闭",-1)])]),_:1}),a(P,{type:"primary",onClick:N},{default:i(()=>[...e[17]||(e[17]=[p("尝试示例",-1)])]),_:1})]),default:i(()=>[n.value?(d(),u("div",Ve,[t("div",De,[t("div",Se,[t("div",Ae,[a(V,{type:x(n.value.category)},{default:i(()=>[p(o(I(n.value.category)),1)]),_:1},8,["type"]),a(V,{type:L(n.value.difficulty)},{default:i(()=>[p(o(T(n.value.difficulty)),1)]),_:1},8,["type"])]),t("div",qe,[t("span",null,"浏览: "+o(n.value.views),1),t("span",null,"评分: "+o(n.value.rating)+"/5.0",1),t("span",null,"更新: "+o(n.value.updatedAt),1)])])]),t("div",Ie,[t("div",Te,[e[11]||(e[11]=t("h3",null,"应用场景",-1)),t("p",null,o(n.value.scenario),1)]),t("div",Ce,[e[12]||(e[12]=t("h3",null,"技术栈",-1)),t("div",Fe,[(d(!0),u(m,null,f(n.value.technologyDetails,s=>(d(),u("div",{key:s.name,class:"tech-item"},[t("strong",null,o(s.name)+":",1),p(" "+o(s.description),1)]))),128))])]),t("div",ze,[e[13]||(e[13]=t("h3",null,"代码示例",-1)),t("div",Re,[t("pre",Ue,o(n.value.codeExample),1)])]),t("div",xe,[e[14]||(e[14]=t("h3",null,"最佳实践",-1)),t("ul",Le,[(d(!0),u(m,null,f(n.value.bestPractices,s=>(d(),u("li",{key:s},o(s),1))),128))])]),t("div",je,[e[15]||(e[15]=t("h3",null,"常见问题",-1)),t("div",Ne,[(d(!0),u(m,null,f(n.value.faq,s=>(d(),u("div",{key:s.question,class:"faq-item"},[t("div",Me,[t("strong",null,"Q: "+o(s.question),1)]),t("div",Be," A: "+o(s.answer),1)]))),128))])])])])):le("",!0)]),_:1},8,["modelValue","title"])])}}});const Ye=K(Ke,[["__scopeId","data-v-7cd9f191"]]);export{Ye as default};
